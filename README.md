# CSS
>  Juice 라는 프로젝트를 진행한 적이 있습니다. AWS를 활용하여 주식 데이터들을 DB에 저장하고 react를 통해 웹페이지를 구현하는 프로젝트였습니다. 그 당시 js와 html로만 웹 페이지를 제작하고  CSS의 지식은 거의 밑바닥인 상태로 진행했었습니다. .css파일을 안쓰고 .html 태그 안에서 그냥 주먹구구식으로 스타일을 작성했었네요. bootstrap만을 이용하여 페이지를 꾸며 제가 원하는 모습대로 안나온 기억이 있습니다. 그 때의 아쉬움 때문에 이렇게 CSS를 다시 공부하게 되었습니다. 저만의 언어로 CSS를 정리해보았습니다.
## 1. CSS의 개념
